...
import styles from '../asses3/asses3.module.css'
import EmployerNavbar from '../../employernavbar/navbar'
import Box from '@material-ui/core/Box'
export default function Asses3() {
  return (
    <>
      <EmployerNavbar />
      <Box className={styles.container}>
        ...
        <div className="d-flex">
          ...
          <Box className={styles.b1}>
            <div className="d-flex">
              <p>Business Development Representive</p>
              <Image
                src="/close.png"
                height={15}
                width={15}
